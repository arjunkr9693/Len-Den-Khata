...
@Database(entities = [CustomerEntity::class, SupplierEntity::class, TransactionEntity::class, CustomerTransactionEntity::class, UploadStatusEntity::class], version = 1)
