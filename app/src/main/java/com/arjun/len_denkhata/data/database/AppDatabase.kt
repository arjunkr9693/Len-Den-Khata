...
import com.arjun.len_denkhata.data.database.transactions.monthbook.MonthBookTransaction
import com.arjun.len_denkhata.data.database.transactions.monthbook.MonthBookTransactionDao

@Database(entities = [CustomerEntity::class, SupplierEntity::class, TransactionEntity::class, CustomerTransactionEntity::class, SyncStatusEntity::class, MonthBookTransaction::class], version = 1)
...
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun uploadStatusDao(): SyncStatusDao
